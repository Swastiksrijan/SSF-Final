    ...
    <section id="admin-overview" className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 pt-6 scroll-mt-24">
      <div className="rounded-[2rem] bg-[#002344] text-white p-6 sm:p-8 shadow-sm overflow-hidden relative">
        ...
        <div className="relative flex flex-col xl:flex-row xl:items-end xl:justify-between gap-6">
          <div><p className="text-xs font-black uppercase tracking-[0.22em] text-[#ffb067]">Swastik Srijan Foundation</p><h1 className="text-3xl sm:text-4xl font-black mt-2">Admin Command Center</h1><p className="text-white/70 mt-2 max-w-3xl">One place to review applications, manage people, approve roles, issue official records and keep SSF operational data organized.</p></div><div className="flex flex-wrap items-center gap-2"><a href="/SSFDigitalOffice" className="inline-flex items-center justify-center rounded-xl bg-white text-[#002344] px-4 py-2.5 text-sm font-black hover:bg-zinc-100">SSF Digital Office</a><button type="button" onClick={handleLogout} className="inline-flex items-center gap-2 rounded-xl border border-white/15 bg-white/10 px-4 py-2.5 text-sm font-black text-white hover:bg-white/15"><FaSignOutAlt /> Logout</button></div>
