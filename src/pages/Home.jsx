...
export default function Home() {
  ...
  const quickActions = [
    { title: "Join SSF", text: "Become part of the journey", path: "/Join", icon: <FaUsers /> },
  ...
  return (
    <div className="w-full bg-white font-sans text-zinc-800">
              ...
              {[
                ...
                >
                  ...
                  <span className="group/cta relative z-10 mt-5 inline-flex items-center gap-2 overflow-hidden px-6 py-3 rounded-full bg-gradient-to-r from-[#002344] to-[#064b78] text-white text-sm md:text-base font-extrabold tracking-[0.02em] shadow-lg shadow-[#002344]/20 border border-white/10 group-hover:-translate-y-0.5 group-hover:shadow-xl transition-all duration-200">
                    ...
                    <span className="absolute inset-0 opacity-0 group-hover/cta:opacity-100 bg-gradient-to-r from-[#064b78] to-[#0a668f] transition-opacity duration-200" />
                  </span>
                </Link>
              ))}
            </div>
      ...
      <section className="py-16 bg-[#001529] text-white"><div className="container mx-auto px-4 max-w-6xl"><div className="grid md:grid-cols-[0.9fr_1.5fr] gap-10 items-center"><motion.div initial={{opacity:0,x:-20}} whileInView={{opacity:1,x:0}} viewport={{once:true}} className="text-center md:text-left"><div className="relative inline-block"><OptimizedImage src="/Teams_Images/ramesh_pandey.jpg" alt="Mr. Ramesh Pandey, Founder & President" className="w-44 h-44 md:w-52 md:h-52 rounded-full object-cover border-4 border-white/20 shadow-2xl" /></div><p className="text-[#FF6600] font-bold text-sm tracking-[0.2em] uppercase mt-6">Founder’s Message</p><h2 className="text-3xl md:text-4xl font-bold mt-2">Mr. Ramesh Pandey</h2><p className="text-zinc-300 mt-2 font-medium">Founder & President</p></motion.div><motion.div initial={{opacity:0,x:20}} whileInView={{opacity:1,x:0}} viewport={{once:true}} className="relative"><div className="text-[#FF6600] text-5xl leading-none font-serif mb-2">“</div><h3 className="text-2xl md:text-3xl font-bold leading-snug">Service becomes meaningful when it reaches people with dignity, cooperation and hope.</h3><p className="text-zinc-300 text-lg leading-relaxed mt-6">Swastik Srijan Foundation was founded with the belief that positive change grows when people come together, learn together and take responsible action. Our journey is rooted in education, skills, awareness, health, cooperation and community participation.</p><p className="text-zinc-300 text-lg leading-relaxed mt-4">We may begin with limited resources, but sincere effort, transparency and the willingness to serve can create lasting possibilities. We invite citizens, volunteers, institutions and partners to join this journey and contribute to a stronger, more aware and inclusive society.</p><div className="mt-7"><Link to="/About" className="inline-flex items-center gap-2 px-7 py-3 rounded-full border-2 border-white/70 text-white font-bold hover:bg-white hover:text-[#002344] transition-all">Read More About SSF <FaArrowRight /></Link></div></motion.div></div></div></section>
