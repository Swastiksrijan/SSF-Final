                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <div className="lg:col-span-2 rounded-[3rem] overflow-hidden shadow-xl h-[400px]">
                            <img src="/images/uploads/community-banner.jpg" alt="Children Unity" className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" />
                        </div>
                        <div className="rounded-[3rem] overflow-hidden shadow-xl h-[400px]">
                            <img src="/images/uploads/community-banner.jpg" alt="Slum Outreach" className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" />
                        </div>
                        <div className="rounded-[3rem] overflow-hidden shadow-xl h-[400px]">
                        ...
                        <div className="rounded-[3rem] overflow-hidden shadow-xl h-[400px]">
                            <img src="/images/uploads/community-banner.jpg" alt="Rural Children" className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" />
                        </div>
                        <div className="rounded-[3rem] overflow-hidden shadow-xl h-[400px]">
