...
function MeetingResolutions({rows,add,archive}){
 ...
 const [f,setF]=useState(blank),[notice,setNotice]=useState(""),[saving,setSaving]=useState(false),[syncing,setSyncing]=useState(false),[editingId,setEditingId]=useState(null);
 const set=(k,v)=>setF(x=>({...x,[k]:v}));
