...
function OnlineMeetings({token}){
 ...
 const shareWhatsApp=()=>{if(!link){setNotice("Pehle Google Meet create karein.");return;}const text="Swastik Srijan Foundation Samiti\\n\\nOnline Meeting: "+title+"\\nDate: "+date+"\\nTime: "+time+"\\nType: "+type+"\\nAgenda: "+(agenda||"As per meeting notice")+"\\n\\nJoin Google Meet: "+link;window.open("https://wa.me/?text="+encodeURIComponent(text),"_blank");};
