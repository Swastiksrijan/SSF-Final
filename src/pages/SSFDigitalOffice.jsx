...
function Register({ type, rows, onAdd, onRemove }) {
  ...
  return <div className="space-y-6">
    ...
    <form onSubmit={submit} className="grid sm:grid-cols-2 lg:grid-cols-4 gap-3 p-4 bg-zinc-50 rounded-2xl border border-zinc-100">
      <input className="w-full px-3 py-3 rounded-xl border border-zinc-200 bg-white outline-none focus:ring-2 focus:ring-[#002344]/20" placeholder="Name / Party" value={form.name} onChange={e => setForm({ ...form, name: e.target.value })} required />
      {money ? <input className="w-full px-3 py-3 rounded-xl border border-zinc-200 bg-white outline-none focus:ring-2 focus:ring-[#002344]/20" type="number" min="0" step="0.01" placeholder="Amount" value={form.amount} onChange={e => setForm({ ...form, amount: e.target.value })} /> : <input className="w-full px-3 py-3 rounded-xl border border-zinc-200 bg-white outline-none focus:ring-2 focus:ring-[#002344]/20" placeholder="Email" value={form.email} onChange={e => setForm({ ...form, email: e.target.value })} />}
      {money ? <select className="w-full px-3 py-3 rounded-xl border border-zinc-200 bg-white outline-none focus:ring-2 focus:ring-[#002344]/20" value={form.mode} onChange={e => setForm({ ...form, mode: e.target.value })}><option>Cash</option><option>Bank</option><option>UPI</option><option>Other</option></select> : <input className="w-full px-3 py-3 rounded-xl border border-zinc-200 bg-white outline-none focus:ring-2 focus:ring-[#002344]/20" placeholder="Phone" value={form.phone} onChange={e => setForm({ ...form, phone: e.target.value })} />}
      <input className="w-full px-3 py-3 rounded-xl border border-zinc-200 bg-white outline-none focus:ring-2 focus:ring-[#002344]/20" placeholder="Note / Purpose" value={form.note} onChange={e => setForm({ ...form, note: e.target.value })} />
