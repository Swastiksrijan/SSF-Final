  ...
  <div className="bg-white border rounded-2xl overflow-hidden">
   ...
   <div className="overflow-auto"><table className="w-full text-sm min-w-[1900px]"><thead className="bg-slate-50"><tr>
    ...
    {visible.map(function(r,i){const d=r.data||{};return <tr key={r.id}>
     ...
     <td className="p-3 whitespace-nowrap"><button type="button" onClick={()=>editRecord(r)} className="px-3 py-2 rounded-lg bg-[#1F7A70] text-white font-bold hover:bg-[#17665D] mr-2">Edit</button><button type="button" onClick={()=>archive(r.id)} className="px-3 py-2 rounded-lg border border-rose-200 text-rose-700 font-bold hover:bg-rose-50">Archive</button></td>
    </tr>})}
  ...
  <div className="bg-white border rounded-2xl overflow-hidden">
   ...
   <div className="overflow-auto"><table className="w-full text-sm min-w-[1700px]">
    ...
    <tbody className="divide-y">{existing.map(r=>{const d=r.data||{};return <tr key={r.id}>
     ...
     <td className="p-3 sticky right-0 bg-white border-l z-10 whitespace-nowrap"><button type="button" onClick={()=>editRecord(r)} className="px-3 py-2 rounded-lg bg-[#1F7A70] text-white font-bold hover:bg-[#17665D] mr-2">Edit</button><button type="button" onClick={()=>archive(r.id)} className="px-3 py-2 rounded-lg border border-rose-200 text-rose-700 font-bold hover:bg-rose-50">Archive</button></td>
