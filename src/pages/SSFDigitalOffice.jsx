...
function NotificationForm({types,onSave,initial={},onCancel}){
 const [f,setF]=useState({date:initial.date||new Date().toISOString().slice(0,10),name:initial.name||"",role:initial.role||"",noticeStage:initial.noticeStage||types[0]||"",subject:initial.subject||"",details:initial.details||"",channel:initial.channel||"Official WhatsApp Group",expectedAction:initial.expectedAction||"",expectedDate:initial.expectedDate||"",responseStatus:initial.responseStatus||"Not Applicable",responseDate:initial.responseDate||"",responseDetails:initial.responseDetails||"",participationStatus:initial.participationStatus||"Not Applicable",followUpDate:initial.followUpDate||"",followUpResult:initial.followUpResult||"",status:initial.status||"active",relatedRecordId:initial.relatedRecordId||"",evidenceRef:initial.evidenceRef||"",mobile:initial.mobile||"",email:initial.email||""});
