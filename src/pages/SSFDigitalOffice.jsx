...
function OnlineMeetings({token}){
 ...
 const shareEmail=()=>{if(!link){setNotice("Pehle Google Meet create karein.");return;}const subject="SSF Online Meeting: "+title;const gmailUrl="https://mail.google.com/mail/?view=cm&fs=1&tf=1&su="+encodeURIComponent(subject)+"&body="+encodeURIComponent(meetingMessage());const popup=window.open(gmailUrl,"_blank","noopener,noreferrer");if(!popup)setNotice("Email window block ho gaya. Browser popup allow karke dobara click karein.");};
