...
const ROLES = [
  ...
  { id: "donor", title: "SUPPORT", text: "अपने resources या financial support से अच्छे काम को आगे बढ़ाना चाहता हूँ।", icon: FaHeart, color: "orange" },
  { id: "partner", title: "PARTNER", text: "अपनी संस्था, company या network के साथ मिलकर काम करना चाहता हूँ।", icon: FaHandshake, color: "violet" },
];
...
export default function JoinFormPage() {
  ...
  return (
    <main className="min-h-screen bg-[#f7fafc] text-[#17202a]">
      <section className="relative overflow-hidden bg-gradient-to-br from-[#001b34] via-[#06284a] to-[#0b4f86] text-white">
        <div className="absolute -right-24 -top-24 h-80 w-80 rounded-full bg-emerald-400/10 blur-2xl" />
        <div className="absolute -left-32 bottom-0 h-72 w-72 rounded-full bg-blue-300/10 blur-2xl" />
        <div className="relative mx-auto max-w-6xl px-6 py-20 md:py-28">
          <p className="text-emerald-300 font-extrabold tracking-[0.2em] text-xs md:text-sm uppercase">Swastik Srijan Foundation • Join Us</p>
          ...
          <p className="mt-7 max-w-2xl text-lg md:text-2xl text-blue-50 leading-relaxed">आपके लिए Swastik Srijan Foundation में कौन-सी जगह है?</p>
