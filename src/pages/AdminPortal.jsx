...
import { FaUsers, FaCheckCircle, FaTimesCircle, FaEye, FaShieldAlt, FaDownload, FaLock, FaIdCard, FaCertificate } from "react-icons/fa";
...
export default function AdminPortal() {
    ...
    const downloadCertificate = async (person, role = "member") => {
        ...
        await generateCertificate(person.fullName, role, date, person.certId);
    };
