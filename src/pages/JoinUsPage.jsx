...
const ROLES = [
  { id: "member", title: "MEMBER", text: "Swastik Srijan Foundation / स्थापना की यात्रा का हिस्सा बनना चाहता हूँ।", icon: FaUsers, color: "blue" },
  { id: "volunteer", title: "VOLUNTEER / स्वयंसेवक", text: "अपने समय, ज्ञान या skill से सक्रिय रूप से योगदान करना चाहता हूँ। / I want to contribute actively with my time, knowledge or skills.", icon: FaHandsHelping, color: "green" },
  { id: "donor", title: "SUPPORT / सहयोग", text: "अपने resources या financial support से अच्छे काम को आगे बढ़ाना चाहता हूँ। / I want to support good work with resources or financial support.", icon: FaHeart, color: "navy" },
    ...
    <main className="min-h-screen bg-[#f7fafc] text-[#17202a]">
      <section className="relative overflow-hidden bg-gradient-to-br from-[#06284a] via-[#0b4f86] to-[#168a5a] text-white">
        ...
        <div className="relative mx-auto max-w-6xl px-6 py-20 md:py-28">
          <p className="text-emerald-300 font-extrabold tracking-[0.2em] text-xs md:text-sm uppercase">Swastik Srijan Foundation / स्थापना • Join Movement / जुड़ाव अभियान</p>
          ...
          <p className="mt-7 max-w-2xl text-lg md:text-2xl text-slate-100 leading-relaxed">आपके लिए Swastik Srijan Foundation / स्थापना में कौन-सी जगह है?</p>
          <button onClick={() => document.getElementById("find-place")?.scrollIntoView({ behavior: "smooth" })} className="mt-8 inline-flex items-center gap-3 rounded-full bg-white px-7 py-3.5 text-[#06284a] font-black shadow-xl hover:-translate-y-1 transition">अपनी जगह चुनें / FIND YOUR PLACE <FaArrowRight /></button>
        </div>
      </section>

      <section id="find-place" className="mx-auto max-w-6xl px-5 py-16 md:py-20 scroll-mt-16">
        <div className="text-center max-w-3xl mx-auto"><p className="text-emerald-600 font-extrabold tracking-[0.18em] text-xs md:text-sm uppercase">01 • Find Your Place / अपनी जगह चुनें</p><h2 className="mt-3 text-3xl md:text-5xl font-black text-[#06284a]">आप किस तरह जुड़ना चाहेंगे? / How would you like to join?</h2><p className="mt-4 text-slate-500 text-base md:text-lg">अपनी भूमिका चुनिए। फिर हम आपको उसी रास्ते से आगे ले जाएँगे। / Choose your role and we will guide you on that path.</p></div>
