...
export default function JoinUsPage() {
  ...
  return (
    <main className="min-h-screen bg-[#f7fafc] text-[#17202a]">
        ...
        <div className="relative z-10 flex min-h-[68vh] lg:min-h-[72vh] items-center justify-center px-5 py-24 lg:px-8">
          <div className="max-w-6xl w-full text-center">
            <div className="mx-auto inline-block rounded-2xl border border-white/15 bg-[#001529]/55 px-6 py-5 sm:px-12 sm:py-6 backdrop-blur-sm shadow-2xl">
              ...
              <h1 className="mt-5 md:mt-6 text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black leading-tight tracking-tight text-white">कुछ लोग बदलाव की प्रतीक्षा करते हैं।<span className="block mt-2 text-[#7dd3a8]">Some wait for change. कुछ बदलाव का हिस्सा बनते हैं।</span></h1>
              <p className="mx-auto mt-5 max-w-5xl text-base md:text-lg text-[#e5edf4] leading-relaxed">Find your place in Swastik Srijan Foundation / स्थापना. / Swastik Srijan Foundation / स्थापना में आपके लिए कौन-सी भूमिका है?</p>
      ...
      <section id="find-place" className="mx-auto max-w-6xl px-5 py-14 md:py-18 scroll-mt-16">
        <div className="text-center max-w-3xl mx-auto"><p className="leading-relaxed text-emerald-600 font-extrabold tracking-[0.18em] text-xs md:text-sm uppercase">01 • FIND YOUR PLACE / अपनी भूमिका चुनें</p><h2 className="mt-3 text-2xl md:text-4xl font-black text-[#06284a]">How would you like to join? / आप किस तरह जुड़ना चाहेंगे?</h2><p className="mt-4 text-slate-500 text-base md:text-lg">Choose your role, and take the next step with us. / अपनी भूमिका चुनिए और हमारे साथ अगला कदम बढ़ाइए।</p></div>
      ...
      <section className="mx-auto max-w-5xl px-5 py-16 md:py-20"><div className="rounded-[2rem] bg-white border border-slate-200 shadow-[0_20px_60px_rgba(6,40,74,0.10)] p-5 md:p-8"><div className="text-center mb-9 max-w-4xl mx-auto"><p className="leading-relaxed text-emerald-600 font-extrabold tracking-[0.18em] text-xs uppercase">07 • START YOUR JOURNEY / अपनी यात्रा शुरू करें</p><h2 className="mt-3 text-3xl md:text-5xl font-black text-[#06284a]">Take your first step as {selectedRole.title}. / {selectedRole.title} के साथ अपना पहला कदम उठाइए</h2><p className="mt-3 text-slate-500">Your form is below according to your selected role. / आपकी चुनी हुई भूमिका के अनुसार form नीचे है।</p></div><RoleForm active={active} /></div></section>
