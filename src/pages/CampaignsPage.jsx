...
const campaigns = [
  { id:"education", icon:<FaGraduationCap/>, title:"Education", hindi:"शिक्षा अभियान", tagline:"ज्ञान से अवसर, अवसर से विकास", items:["प्राथमिक, माध्यमिक, उच्च माध्यमिक विद्यालय","कॉलेज","कंप्यूटर शिक्षा","नर्सिंग","तकनीकी शिक्षा","प्रतियोगी परीक्षा कोचिंग","पुस्तकालय","विज्ञान मेले"], gradient:"from-[#fb8500] to-[#e76f00]", image:"/images/real/scholarship_distribution.jpg" },
  ...
  { id:"agriculture", icon:<FaHome/>, title:"Agriculture & Rural Development", hindi:"कृषि एवं ग्रामीण विकास अभियान", tagline:"गांव मजबूत, देश मजबूत", items:["जैविक खेती","किसानों का प्रशिक्षण","पशुपालन","गौ संरक्षण","ग्रामीण विकास","आजीविका"], gradient:"from-[#588157] to-[#344e41]", image:"/images/community-team-group.jpg" },
  { id:"socialJustice", icon:<FaBullhorn/>, title:"Social Justice", hindi:"सामाजिक न्याय अभियान", tagline:"जागरूक नागरिक, मजबूत समाज", items:["भ्रष्टाचार जागरूकता","नैतिक शिक्षा","राष्ट्रीय एकता","सांप्रदायिक सद्भाव","मानव अधिकार"], gradient:"from-[#264653] to-[#1d3557]", image:"/images/real/awareness-poster-viewing.jpg" },
  { id:"disability", icon:<FaHandsHelping/>, title:"Disability & Rehabilitation", hindi:"दिव्यांग एवं पुनर्वास अभियान", tagline:"सहयोग, सम्मान और पुनर्वास", items:["दिव्यांग सहायता","मानसिक रूप से कमजोर बच्चों का पुनर्वास","वृद्धजन सहायता","अनाथ सहायता"], gradient:"from-[#6a4c93] to-[#3c096c]", image:"/images/real/children-playing-park.jpg" },
