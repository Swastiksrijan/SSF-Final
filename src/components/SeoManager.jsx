...
const SeoManager = () => {
  ...
  useEffect(() => {
    const seoData = {
      '/': { title: 'Swastik Srijan Foundation | Empowering Lives Across India', description: 'Join Swastik Srijan Foundation, a registered NGO in India working for education, health, livelihoods, women empowerment & rural development since 2013.', keywords: 'NGO India, Swastik Srijan, education NGO, health NGO, social welfare, donate NGO, volunteer India' },
      ...
      '/OurInitiatives': { title: 'Our Initiatives & Impact | Swastik Srijan Foundation', description: 'Explore Swastik Srijan Foundation initiatives across education, health awareness, counselling, skills, women empowerment, environment, rural development and social awareness.', keywords: 'NGO initiatives India, NGO activities, education NGO, health awareness NGO, women empowerment, rural development, social awareness' },
      ...
      '/Donate': { title: 'Donate to Swastik Srijan Foundation | Support Our Mission', description: 'Your donation supports education, health, livelihoods, and community development. Every contribution can help strengthen our social initiatives.', keywords: 'donate to NGO, charitable donation, NGO fundraising, support cause' },
    ...
    const meta = seoData[pathname] || { title: 'Swastik Srijan Foundation | Social Impact Organization', description: 'Swastik Srijan Foundation - Working for education, health, livelihood, and community development across India.', keywords: 'NGO, social work, community development, India' };

    document.title = meta.title;
    const setMeta = (selector, content) => { const tag = document.querySelector(selector); if (tag) tag.setAttribute('content', content); };
