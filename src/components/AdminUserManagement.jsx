...
export default function AdminUserManagement() {
  ...
  return <section id="admin-user-management" className="bg-white rounded-[2.5rem] shadow-sm border border-zinc-100 overflow-hidden mt-8">
    <div className="p-8 border-b border-zinc-100">
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
        <div><p className="text-xs font-black uppercase tracking-widest text-[#FF6600]">People & Accounts</p><h2 className="text-2xl font-black text-[#002344] mt-1">User Management</h2><p className="text-sm text-zinc-500 mt-1">Manage website accounts. Permanent deletion is intentionally protected by a second confirmation.</p></div>
