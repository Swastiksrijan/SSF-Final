...
import { FaArrowRight, FaCalendarAlt, FaCheckCircle, FaGraduationCap, FaHandshake, FaTimes, FaTools, FaUsers, FaSpinner } from "react-icons/fa";
import { ENDPOINTS } from "../config/api";
import InternshipForm from "./InternshipForm";
import MemberForm from "./MemberForm";

const FORM_CONFIG = {
  volunteer: { title: "Volunteer", icon: FaUsers, eyebrow: "Become part of SSF", description: "Use the same working membership form for volunteer participation." },
...
export default function UserParticipationForms({ openForm, onClose }) {
  ...
  const renderForm = () => { if (openForm === "membership" || openForm === "volunteer") return <MemberForm />; if (["activities", "partnership", "skills"].includes(openForm)) return <ParticipationForm kind={openForm} />; if (openForm === "internship") return <InternshipForm />; return null; };
