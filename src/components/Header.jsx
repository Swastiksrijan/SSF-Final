...
const Header = () => {
  ...
  return <header className="fixed top-0 left-0 right-0 z-50 font-sans">
    ...
    {menuOpen && <div className="md:hidden fixed inset-0 top-[116px] bg-white z-40 overflow-y-auto pb-20"><nav className="p-6">
      {!user && <div className="mb-5 flex gap-3"><Link to="/Members" onClick={closeMenu} className="flex-1 py-3.5 rounded-2xl border-2 border-[#002344] text-[#002344] text-center font-extrabold tracking-wide">Member</Link><button onClick={() => { closeMenu(); openAuth("signup"); }} className="flex-1 py-3.5 rounded-2xl bg-gradient-to-r from-[#002344] to-[#064b78] text-white font-extrabold tracking-wide shadow-lg">Join SSF</button></div>}
