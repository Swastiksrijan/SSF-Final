...
router.post('/member-payment-link', async (req, res) => {
    try {
        ...
        const payload = {
            amount: amountRupees * 100, currency: 'INR', accept_partial: false, reference_id: referenceId,
            ...
            notify: { email: true, sms: false }, reminder_enable: true,
            notes: { member_id: member.id, member_type: member.memberType },
            callback_url: `${backendUrl}/api/member-payment-callback`, callback_method: 'get'
        };
